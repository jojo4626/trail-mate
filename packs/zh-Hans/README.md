...
python tools/generate_binfont_with_lv_font_conv.py `
  ...
  --charset-file packs/zh-Hans/fonts/zh-hans-core/charset.txt `
  --output packs/zh-Hans/fonts/zh-hans-core/font.bin `
  --size 16 `
  --bpp 2 `
...
python tools/generate_binfont_with_lv_font_conv.py `
  --font tools/fonts/NotoSansCJKsc-Regular.otf `
  --charset-file packs/zh-Hans/fonts/zh-hans-ext/charset.txt `
  --output packs/zh-Hans/fonts/zh-hans-ext/font.bin `
  --size 16 `
  --bpp 2 `
  --node-exe C:\Users\VicLi\AppData\Local\nodejs22\current\node.exe `
  --no-compress
